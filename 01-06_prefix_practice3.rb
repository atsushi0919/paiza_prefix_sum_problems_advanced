...
ある整数 K (0 ≦ K ≦ N-1) を考えたとき、a_0 + a_1 + ... + a_K を sum1 、a_(K+1) + a_(K+2) + ... + a_{N-1} を sum2 とします。

K = 0 の場合から K = N-1 の場合まで全て考えたとき、sum1 と sum2 の差の絶対値 |sum1 - sum2| の最小値を累積和を用いて求め、一行で出力してください。
